    ...
    <AdminLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-slate-900">Partners & Suppliers</h1>
            <p className="text-slate-600 mt-2">Manage supplier/partner logos displayed on the website</p>
          </div>
          <button
            onClick={() => {
              setShowAddForm(true);
